...
const styles = StyleSheet.create({
  ...
  comingSoonBadge: { position: "absolute" as const, top: -12, right: -14, backgroundColor: "rgba(245,158,11,0.9)", borderRadius: 999, paddingVertical: 2, paddingHorizontal: 6, alignItems: "center" as const, justifyContent: "center" as const },
