...
const styles = StyleSheet.create({
  ...
  comingSoonBadge: { position: "absolute" as const, top: 0, left: 0, right: 0, bottom: 0, backgroundColor: "rgba(245,158,11,0.85)", borderRadius: 12, alignItems: "center" as const, justifyContent: "center" as const },
