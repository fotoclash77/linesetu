      ...
      >
        ...
        <View style={styles.quickLinksRow}>
          {[
            ...
            { icon: "list" as const, label: "My Queue", color: "#06B6D4", glow: "rgba(6,182,212,0.3)", onPress: () => router.push(`/queue/${activeToken?.id ?? "demo"}` as any) },
...
const styles = StyleSheet.create({
  ...
  verifiedBadge: { flexDirection: "row", alignItems: "center", gap: 3, backgroundColor: "rgba(10,14,26,0.72)", borderRadius: 999, paddingHorizontal: 5, paddingVertical: 3, borderWidth: 1, borderColor: "rgba(6,182,212,0.2)" },
